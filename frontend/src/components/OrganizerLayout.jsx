...
const OrganizerLayout = ({ children }) => {
  ...
  const navigation = [
    { name: 'Overview', href: '/organizer', icon: Squares2X2Icon },
    { name: 'Sessions', href: '/organizer/sessions', icon: VideoCameraIcon },
    { name: 'Speakers', href: '/organizer/speakers', icon: UsersIcon },
    { name: 'Tracks', href: '/organizer/tracks', icon: QueueListIcon },
    { name: 'Rooms', href: '/organizer/rooms', icon: HomeModernIcon },
    { name: 'Schedule Planner', href: '/organizer/schedule', icon: CalendarIcon },
    { name: 'Analytics', href: '/organizer/analytics', icon: ChartBarIcon },
    { name: 'Notifications', href: '/organizer/notifications', icon: BellIcon },
  ];
        ...
        <header className="lg:hidden h-16 bg-white border-b border-slate-200 flex items-center px-4 shrink-0">
          ...
          <div className="ml-4 flex-1">
            <h2 className="text-lg font-bold text-slate-900">
              {navigation.find(n => n.href === currentPath)?.name || 'Organizer'}
            </h2>
          </div>
        </header>
